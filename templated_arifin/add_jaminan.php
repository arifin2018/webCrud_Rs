    ...
    <div id="main">
        <div id="banner">
            ...
            if (isset($_POST['Submit'])) {
                ...
                $result = mysqli_query($mysqli, "INSERT INTO jaminan (jaminan) VALUES ('$jaminan')");
                echo "User added seccessfully.<a href='jaminan.php'>View Data Jaminan Pembayaran</a>";
            }
                ?>
